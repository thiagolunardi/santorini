...
namespace Santorini.Host.Mcp
{
    ...
    public class GameMcpTools
    {
        ...
        public object MoveWorker(
            [Description("The name of the player (e.g., 'Player1')")] string playerName,
            [Description("The worker number (1 or 2)")] int workerNumber,
            [Description("X coordinate to move to")] int moveToX,
            [Description("Y coordinate to move to")] int moveToY,
            [Description("X coordinate to build at")] int buildAtX,
            [Description("Y coordinate to build at")] int buildAtY)
        {
